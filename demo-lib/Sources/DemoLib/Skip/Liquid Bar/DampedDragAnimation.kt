...
/**
 * Drives a draggable value (e.g. a tab index) with spring-damped
 * settling, velocity tracking, and a press-driven scale — the same
 * building block Kyant's demo components use for their liquid pills.
 */
